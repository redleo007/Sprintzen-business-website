...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sprintzen — Real-time Agile Planning Workspace" },
      {
        name: "description",
        content:
          "Sprintzen unites planning poker, live Kanban, shared notes and sprint analytics in one real-time agile workspace.",
      },
      { property: "og:title", content: "Sprintzen — Real-time Agile Planning Workspace" },
      {
        property: "og:description",
        content:
          "Planning poker, live Kanban and sprint forecasting for agile teams that ship.",
      },
